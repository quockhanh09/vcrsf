<template>
  ...
  >
    <div
      class="tablet:w-1/2 border border-borderGray rounded-t-[5px] tablet:rounded-tr-[0px] tablet:rounded-l-[5px] px-[30px] py-[20px]"
    >
      <div
        class="py-4 flex justify-between items-center border-b border-borderGray"
      >
      ...
      <div class="my-8 p-[2.5rem] bg-lightGray rounded-[20px]">
    ...
    <div
      class="tablet:w-1/2 border border-borderGray rounded-b-[5px] tablet:rounded-bl-[0px] tablet:rounded-r-[5px]"
    >
      <div
        class="h-[143px] p-[20px] bg-lightGray flex flex-col items-center border-b border-borderGray"
      >
        ...
        <div
          class="bg-yellow w-[80px] h-[80px] p-[16px] rounded-full flex justify-center items-center mt-2"
        >
          <p class="text-center font-bold">
            Ngày
            {{
              selectedDate
                ? selectedDate?.toLocaleString('vi-VI', {
                    day: 'numeric',
                  })
