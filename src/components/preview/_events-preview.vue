<template>
  <article
    class="relative w-[415px] h-[280px] mx-[10px] text-white flex flex-col items-start gap-[20px] rounded-[13px]"
  >
    <div class="absolute w-full h-full -z-10">
      <img
        class="w-full h-full rounded-[13px]"
        v-lazy="events?.image || demoImg2"
        :alt="events?.name"
      />
    </div>
    <div
      class="h-full py-[26px] px-[20px] flex flex-col justify-between items-start"
    >
      <div>
      ...
      <div class="flex flex-col items-start gap-[10px]">
        <div>
          <h4 class="min-h-[70px] text-start text-lg tablet:text-[22px]">
            {{
        ...
        <!-- <div class="my-[10px]">
          <button class="relative text-[14px] text-blue">
            {{ t('read-more') }}
          </button>
        </div> -->
      </div>
