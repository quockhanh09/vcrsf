...
const routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        redirect: { name: 'AboutDetails', params: { id: 'Giới thiệu' } },
        children: [
          {
            path: ':id',
            name: 'AboutDetails',
            component: () => loadDetails('_about-details'),
          },
        ],
      },
      {
        ...
        redirect: { name: 'GenreDetails', params: { id: 'canoeing' } },
        children: [
          {
            path: ':id',
            alias: 'genre',
            name: 'GenreDetails',
            component: () => loadDetails('_genre-details'),
          },
        ],
      },
      {
